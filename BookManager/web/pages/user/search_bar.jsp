    ...
    <div class="input-group-prepend">
        <div id="search-dropdown" class="dropdown">
          ...
          <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
            ...
            <a class="dropdown-item" href="#" name="email">Search by email</a>
            <a class="dropdown-item" href="#" name="fullname">Search by full name</a>
            <a class="dropdown-item" href="#" name="phone">Search by phone</a>
          </div>
        </div>
    </div>
