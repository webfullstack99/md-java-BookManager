 ...
 * @author Asus ZenBook
 */
@WebServlet(name = "category/save", urlPatterns = {"/category/save"})
public class Save extends HttpServlet {
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            String data[]       = Helper.createCategoryDataByRequest(request);
            // add
            if (id < 0){            
                Category item   = new Category(list.getNewId()+"", data[0], data[1]);
            ...
            // edit
                ...
                item.setMultiValue(id+"", data[0], data[1]);
